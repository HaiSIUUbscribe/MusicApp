package com.example.musicapplication.ui.activity.genre;
...
import com.example.musicapplication.ui.adapter.SongListAdapter; // Dùng lại adapter list dọc
...
public class GenreDetailActivity extends AppCompatActivity {
    ...
    private void loadSongsByGenre() {
        ...
        // Gọi hàm tìm kiếm theo Tag trong SearchRepository
        searchRepository.getSongsByTag(genreName, new SearchRepository.OnResultListener<List<Song>>() {
            @Override
